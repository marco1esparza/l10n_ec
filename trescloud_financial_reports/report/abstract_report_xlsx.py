...
class AbstractReportXslx(models.AbstractModel):
    _name = "report.trescloud_financial_reports.abstract_report_xlsx"
    ...
    def _define_formats(self, workbook, report_data):
        ...
        report_data["formats"] = {
            ...
            "format_bold_30": workbook.add_format({"bold": True, "font_size": 30}),
            "format_bold_30_wrap": workbook.add_format({"bold": True, "font_size": 30, "text_wrap": True,
                                                        "valign": "vcenter"}),
            ...
            "format_header_center": workbook.add_format(
                {"bold": True, "align": "center", "border": True, "bg_color": "#FFFFCC", "text_wrap": True,
                 "valign": "vcenter"}
            ),
    ...
    def _write_report_title(self, title, report_data):
        ...
        Columns are defined with `_get_report_columns` method.
        """
        report_data["sheet"].set_row(report_data["row_pos"], 30)
        report_data["sheet"].merge_range(
            ...
            title,
            report_data["formats"]["format_bold_30_wrap"],
        )
    ...
    def _get_currency_amt_format(self, line_object, report_data):
        ...
        if "currency_id" in line_object and line_object.get("currency_id", False):
            ...
            if hasattr(self, field_name):
                ...
                if "account_group_id" in line_object and line_object["account_group_id"]:
                    format_amt = report_data["workbook"].add_format({"bold": True})
                else:
