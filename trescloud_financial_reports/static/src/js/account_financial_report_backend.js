odoo.define("l10n_ec_financial_reports.account_financial_report_backend", function (
    require
) {
    "use strict";
    ...
    var ReportWidget = require("l10n_ec_financial_reports.account_financial_report_widget");
