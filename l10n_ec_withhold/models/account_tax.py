...
class AccountTax(models.Model):
    ...
    def _search(self, args, offset=0, limit=None, order=None, count=False, access_rights_uid=None):
        ...
        if context.get('l10n_ec_withhold_type_ctx') == 'in_withhold':
            args += [('type_tax_use', '=', 'none'),('tax_group_id.l10n_ec_type', 'in', ['withhold_income_sale', 'withhold_income_purchase'])]
        elif context.get('l10n_ec_withhold_type_ctx') == 'out_withhold':
            args += [('type_tax_use', '=', 'none'),('tax_group_id.l10n_ec_type', 'in', ['withhold_vat_sale', 'withhold_vat_purchase'])]
